...
class ExcelController extends BackendController {
    ...
    public function index($via) {
        ...
        $this->via =$via;
        //$this->excel = $this->excel($via);
    }
    
//    public function excel($via) {
...
//        
//        $objWriter = new PHPExcel_Writer_Excel5($excel); //Escribir archivo
//        
//        // Establecer formado de Excel
//        header("Content-Type: application/vnd.ms-excel");
//
//        // nombre del archivo
//        header('Content-Disposition: attachment; filename="Via '.$via.'.xls"');
